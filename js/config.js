/**
 * config.js - Application Config and Intensity Data
 */
const CONFIG = {
  // --- API Endpoints ---
 ...
 * RGB→震度のルックアップ用
 */
const KMONI_RGB_LOOKUP = new Map();
KMONI_COLOR_TABLE.forEach(([intensity, r, g, b]) => {
  KMONI_RGB_LOOKUP.set(`${r},${g},${b}`, intensity);
});
